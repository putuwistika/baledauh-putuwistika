      ...
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            >
              {/* User Avatar */}
              <div className="w-8 h-8 bg-gradient-to-br from-gold-400 to-gold-500 text-white rounded-full flex items-center justify-center font-semibold text-sm shadow-md">
